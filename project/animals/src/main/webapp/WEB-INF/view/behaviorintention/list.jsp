...
<div>
	<main class="main">
		...
		<h2 class="main title">강아지 행동별 의미</h2>

		<div class="search-form">
			<h3 class="hidden">강아지행동별 의미 검색폼</h3>
			<form class="table-form">
				<fieldset>
					<legend class="hidden">강아지행동별의미 검색분류</legend>
		...
		<div class="notice margin-top">
			<h3 class="hidden">강아지 행동 목록</h3>

			<table border="1" class="table">
				<thead>
					<tr>
						<th style="width: 60px;" class="w60">번호</th>
						<th style="width: 400px; height: 10px;" class="expand">행동</th>
					</tr>
				</thead>
				<tbody>
					<c:forEach var="b" items="${list}">
						<tr>
							...
							<td style="text-align: center;"
								...
								href="detail?id=${b.id}">${b.behavior}</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
