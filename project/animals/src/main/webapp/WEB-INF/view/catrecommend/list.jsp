...
<main class="main">
	...
	<h2 class="main title">반려묘 추천</h2>

	<div class="search-form">
		<h3 class="hidden">반려묘 추천</h3>
		<form class="table-form">
			<fieldset>
				<legend class="hidden">반려묘 검색분류</legend>

				<label></label> <select name="f">
					<option value="catbreed">고양이품종</option>
		...
		<table border="1" class="table">
			<thead>
				<tr>
					...
					<th style="text-align: center;" class="expand">품종</th>
			...
			<tbody>
				<c:forEach var="c" items="${list}">
					<tr>
						<td style="text-align: center; width: 50px;">${c.id}</td>
						<td style="text-align: center; width: 220px"
							class="title ident text-align-left"><a
							href="detail?id=${c.id}">${c.catbreed}</a></td>
						<td style="text-align: center; width: 160px;">${c.country}</td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
