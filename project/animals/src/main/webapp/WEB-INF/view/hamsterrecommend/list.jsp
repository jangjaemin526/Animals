...
<main class="main">
	...
	<h2 class="main title">햄스터 추천</h2>

	<div class="search-form">
		<h3 class="hidden">햄스터 추천</h3>
		<form class="table-form">
			<fieldset>
				<legend class="hidden">햄스터 검색분류</legend>

				<label></label> <select name="f">
					<option value="hamsterbreed">햄스터품종</option>
			...
			<table border="1" class="table">
				<thead>
					<tr>
						...
						<th style="text-align: center;" class="expand">햄스터품종</th>
					</tr>
				</thead>
				<tbody>
					<c:forEach var="hs" items="${list}">
						<tr>
							<td style="text-align: center; width: 50px;">${hs.id}</td>
							<td style="text-align: center; width: 220px"
								class="title ident text-align-left"><a
								href="detail?id=${hs.id}">${hs.hamsterbreed}</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
